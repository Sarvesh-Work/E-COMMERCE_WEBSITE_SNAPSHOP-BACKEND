...
exports.cookieExtractor = function (req) {
  ...
  // token =
  // "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY2NzAxNDhmNTJlM2IxZjJlYzFkMGI2ZSIsInJvbGUiOiJ1c2VyIiwiaWF0IjoxNzE4NjIzMDM4fQ._zjKScuM74V67EcKb8zW_vkrzzPjC7FwXm1XQc1kcXQ";
  return token;
};
...
exports.invoice = function (order) {
  return `<!DOCTYPE html>
<html>
<head>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr>
            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
              <p style="margin: 0;">Here is a summary of your recent order. If you have any questions or concerns about your order, please <a href="sarveshmunde10@gmail.com">contact us</a>.</p>
            </td>
          </tr>
          <!-- end copy -->
                  ...
                  <tr>
                    <td align="left" valign="top" style="padding-bottom: 36px; padding-left: 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                      <p><strong>Delivery Address</strong></p>
                       <p>${order.SelectedAddress.Name}<br>state:${order.SelectedAddress.State}<br>City:${order.SelectedAddress.City}<br>Postal_code:${
                         order.SelectedAddress.Postal_Code
                       }</p>
                      <p>Phone_number:${order.SelectedAddress.Phone_number}</p>
                      <p>Address:${order.SelectedAddress.Address}</p>
                    </td>
                  </tr>
                </table>
              </div>
